...
export default class LinterhubProblemView {
     ...
     * @param {Object} _message - Describes problem (rule, line etc).
     * For more information look at linterhub-ide documentation
     * @param {Object} _file - File path
     */
    constructor(_linter, _message, _file) {
        this.template = fs.readFileSync(
            path.join(__dirname, '/templates/problem-description.html'),
            'utf-8'
        );
    ...
    /**
     * Get LinterhubProblemView element
     * Used to add Problem View to every error in document

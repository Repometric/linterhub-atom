...
export default {
  ...
  */
  add_window_callback(panelItems) {
    console.log('add_window_callback');
    ...
    // let callback = this.warningCallback;
    ...
    // api.analyzeFile(panelItems.getPath(), Run.force)
  ...
  */
  activate() {
    ...
    // this.api.analyzeFile(atom.workspace.getActiveTextEditor().getPath(),
    // Run.force)
    /* if(atom.workspace.getActiveTextEditor()!==undefined){
      this.api.analyzeFile(atom.workspace.getActiveTextEditor()
      .getPath(), Run.force)
    };*/
  ...
  startAnalyze() {
    ...
    this.api.analyzeFile(
      atom.workspace.getActiveTextEditor().getPath(), Run.force);
  },
  ...
  */
  addLinterhubListeners() {
    console.log('addLinterhubListeners');
  ...
  *
  * @return {Object} api for provide linter panel
  */
  provideLinter() {
    let that = this;
    return {
      ...
      lint(textEditor) {
        ...
        return that.api.analyzeFile(editorPath/* , Run.force*/);
        // return api.analyze()
      },
    };
  },

...
import { Integration } from 'linterhub-ide';
...
export default {
  ...
  activate(state) {
    ...
    settings.linterhub.cliPath = atom.config.get('linterhub-atom.path_cli');
    settings.linterhub.mode = atom.config.get('linterhub-atom.mode');
  ...
  provideLinter() {
    ...
    return {
      ...
      lint(textEditor) {
        ...
        // return api.analyzeFile(editorPath)
        return api.analyze();
      }
    }
  }

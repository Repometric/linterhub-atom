...
describe('Integration class', () => {
    ...
    describe("handleErrors method", () => {
        it('should call analyzeFile if path specified', function() {
            let analyzeFileStub = sinon.stub(Linterhub, "analyzeFile").callsFake(function(path) {
            ...
            let analyzeStub = sinon.stub(Linterhub, "analyze").callsFake(function(path) {
                return new Promise((resolve, reject) => {
                    resolve(null);
                });
            });
    ...
    describe('saveConfig method', () => {
        it('should save atom config', () => {
            ...
            expect(atom.config.get('linterhub-atom.path_cli')).toEqual("testpath");
        });
    });
    ...
    describe('convertError method', () => {
        it('should return valid problem', () => {
            ...
            var result = integration.convertError(problem, "linter", "file.js");
            expect(result).toEqual({
                description: (new LinterhubProblemView("linter", problem, "file.js")).getElement().innerHTML,
                severity: "warning",
                location: {
    ...
    describe('sendDiagnostics method', () => {
        var data = "[{\"Name\":\"linter\",\"Model\":{\"Files\":[{\"Path\":\"file.js\",\"Errors\":[{\"Message\":\"description\",\"Rule\":{\"Name\":\"jshint.W083\",\"Id\":null,\"Namespace\":null},\"Severity\":1,\"Evidence\":null,\"Line\":10,\"Column\":{\"Start\":15,\"End\":20},\"Row\":{\"Start\":15,\"End\":15}}]}],\"ParseErrors\":{\"ErrorMessage\":null,\"Input\":null}}}]";
        ...
        it('should call convertError', function() {
            let convertErrorStub = sinon.stub(integration, "convertError").callsFake(function(path) {
                return null;
            });
